...
<form action="/admin/media/category/add/submit" method="post">
    ...
    <div class="category-info">
        ...
        <div class="row mt-3">
            <div class="col-12">
                <button type="submit" name="action"  value="add" class="btn-success">Add New</button>
                @if(!empty($update_preview))
                <button type="submit" name="action" value="update" class="btn-primary">Confirm Update <i class="fa-solid fa-wrench" style="color: #ffffff;"></i></button>
                @endif
            </div>
         </div>
     </div>
