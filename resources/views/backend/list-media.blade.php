...
@foreach ($data as $item)
    <tr>
        ...
        <td>
            <a href="/admin/media/update/{{$item->id}}"><button class="btn-primary"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></button></a>
            <button onclick="delete_value({{$item->id}}, '#media_id' , '#delect_media')" class="btn-danger"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></button>
        </td>
    </tr>
    @php
    $no ++;
