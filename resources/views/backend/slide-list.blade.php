...
<div class="container-slider">
    ...
    <div class="slide_tool">
        @if (!$slide->isEmpty())
          <button class="btn btn-danger" onclick="delete_value({{$item->id}}, '#delete_slide_id' , '#delect_slide')" ><i class="fa-regular fa-trash-can"></i></button>
 
        <button onclick="browse_to_link()" class="btn btn-primary">
        ...
        @endif
        <button onclick="add_slide()" class="btn btn-success"> <i class="fa-solid fa-square-plus"></i>
